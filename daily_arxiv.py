...
def json_to_md(data, md_filename,
               task = '',
               to_web = False,
               use_title = True,
               use_tc = True,
...
def demo(**config):
    ...
    if publish_readme:
        ...
        json_to_md(data_collector, md_file, task='Update Readme', show_badge=show_badge)

    if publish_gitpage:
        md_file = config['md_gitpage_path']
        json_to_md(data_collector, md_file, task='Update GitPage', to_web=True, show_badge=show_badge, use_tc=False, use_b2t=False)

    if publish_wechat:
        md_file = config['md_wechat_path']
        json_to_md(data_collector_web, md_file, task='Update Wechat', to_web=False, use_title=False, show_badge=show_badge)
